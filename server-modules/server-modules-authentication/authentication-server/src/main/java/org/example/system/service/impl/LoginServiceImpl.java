...
public class LoginServiceImpl implements LoginService {
    ...
    public Boolean logout() {
        ...
        userService.clearUserCache(userContextEntity.getId());
        tokenService.clearTokenCache(userContextEntity.getId());
        resourceService.clearResourceCache(userContextEntity.getId());
